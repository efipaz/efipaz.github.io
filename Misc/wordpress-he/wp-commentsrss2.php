...
?>
	<item>
		...
		<content:encoded><![CDATA[<div dir="rtl"><?php echo get_the_password_form() ?></div>]]></content:encoded>
			<?php
			} else {
			?>
		<description><?php comment_text_rss() ?></description>
		<content:encoded><![CDATA[<div dir="rtl"><?php comment_text() ?></div>]]></content:encoded>
			<?php 
