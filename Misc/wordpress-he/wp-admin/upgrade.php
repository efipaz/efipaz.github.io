...
if (!file_exists('../wp-config.php')) die("לא מצאתי קובץ wp-config.php תקין. האם יצרת קובץ wp-config.php באמצעות הקובץ wp-config-sample.pho, עם כל ההגדרות הרלבנטיות?");
...
<head>
	...
	<title>וורדפרס בעברית &rsaquo; שדרוג בסיס הנתונים</title>
	<?php /* WPH - Hebrew title, encoding should be first thing in header */ ?> 
