...
foreach($posts_columns as $column_name=>$column_display_name) {
	...
	case 'date':
		?>
		<td nowrap="nowrap"><?php the_time('j M Y, G:i:s'); ?></td>
		<?php /* WPH - date format */ ?>
		<?php
		break;
	case 'title':
...
<div class="alignright"><?php next_posts_link(__('&laquo; Previous Entries')) ?></div>
<div class="alignleft"><?php previous_posts_link(__('Next Entries &raquo;')) ?></div>
<?php /* WPH - directionality (In Hebrew, back is right and forward is left) */ ?>
</div>
...
<li <?php if ("unapproved" == $comment_status) echo "class='unapproved'"; ?> >
  <?php comment_date('j בF Y') ?> 
  בשעה
  <?php comment_time('G:i:s') ?> 
  <?php /* WPH - Date format. Also, "@" has no meaning in Hebrew  */ ?>
  <?php 
  ...
  <?php /* WPH - Directionality and readbility */ ?>
  <?php comment_text() ?> 
