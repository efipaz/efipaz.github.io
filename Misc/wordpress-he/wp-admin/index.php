...
<p><a href="post.php"><?php _e('Write a post'); ?></a></p>
<p><a href="profile.php"><?php _e('Update your profile or change your password'); ?></a></p>
<p><a href="link-add.php"><?php _e('Add a link to your blogroll'); ?></a></p>
<p><a href="themes.php"><?php _e('Change your site&#8217;s look or theme'); ?></a></p>
<?php /* WPH - CSS box model Hebrew bug. Things would get crazy when using Lists */ ?>
...
<?php
$rss = @fetch_rss('http://www.trans.co.il/wordpress/feed/rss2');
if ( isset($rss->items) && 0 != count($rss->items) ) {
?>
<h3>ידיעות אחרונות מהבלוג של וורדפרס בעברית</h3>
<?php
$rss->items = array_slice($rss->items, 0, 3);
foreach ($rss->items as $item ) {
?>
...
?>
<?php /* WPH - Fetches Hebrew updates from www.trans.co.il/wp */ ?>
