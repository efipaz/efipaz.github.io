    ...
    <legend><?php _e('Basics') ?></legend>
        <table class="editform" width="100%" cellspacing="2" cellpadding="5">
         <tr>
           ...
           <td width="67%"><input dir="ltr" type="text" name="link_url" value="<?php echo $link->link_url; ?>" style="width: 95%;" /></td> <!-- WPH  - directionality -->
         </tr>
         <tr>
	...
	<fieldset class="options">
        ...
        <table class="editform" width="100%" cellspacing="2" cellpadding="5">
            <tr>
            	...
            	<td width="67%"><input dir="ltr" type="text" name="link_rel" id="link_rel" size="50" value="<?php echo $link->link_rel; ?>" /></td> <!-- WPH  - directionality -->
           	</tr>
            <tr>
...
<fieldset class="options">
        ...
        <table class="editform" width="100%" cellspacing="2" cellpadding="5">
         <tr>
           ...
           <td width="67%"><input dir="ltr" type="text" name="link_image" size="50" value="<?php echo $link->link_image; ?>" style="width: 95%" /></td> <!-- WPH  - directionality -->
         </tr>
<tr>
           <th scope="row"><?php _e('RSS URI:') ?> </th>
           <td><input dir="ltr" name="link_rss" type="text" id="rss_uri" value="<?php echo $link->link_rss; ?>" size="50" style="width: 95%" /></td> <!-- WPH  - directionality -->
         </tr>
         <tr>
...
?>
         ...
         <tr>
          ...
          חלון חדש (<code><bdo dir="ltr">_blank</bdo></code>, הקישור יפתח בחלון חדש)</label><br /> <?php /* WPH - translated vague HTML term */ ?>
<label>
<input type="radio" name="link_target" value="_top" <?php echo(($link->link_target == '_top') ? 'checked="checked"' : ''); ?> />
בלי מסגרות (<code><bdo dir="ltr">_top</bdo></code>, הקישור יפתח באותו חלון אבל מחוץ למסגרות)</label><br /> <?php /* WPH - translated vague HTML term */ ?>
<label>
<input type="radio" name="link_target" value=""     <?php echo(($link->link_target == '') ? 'checked="checked"' : ''); ?> />
כרגיל (ללא target, הקישור יפתח באותו חלון)</label><br /> <?php /* WPH - translated vague HTML term */ ?>
