...
?>
  <tr id='page-<?php echo $id; ?>' class='<?php echo $class; ?>'> 
    ...
    <td><?php echo mysql2date('j M Y, G:i:s', $post->post_modified); ?></td>
   	<?php /* WPH - date format */ ?>
...
<input type="text" id="aa" name="aa" value="<?php echo $aa ?>" size="4" maxlength="5" /><br /> בשעה <?php /* WPH - language - @ doesn't mean anything in Hebrew */ ?>
<input type="text" id="mn" name="mn" value="<?php echo $mn ?>" size="1" maxlength="2" /> :
<input type="text" id="hh" name="hh" value="<?php echo $hh ?>" size="1" maxlength="2" /> <?php /* WPH - directionality */ ?>
