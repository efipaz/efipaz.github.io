...
<?php /* WPH - Languge settings for RSS */ ?>
<tr valign="top"> 
<th width="33%" scope="row">שפה לפידים:</th> 
<td><input name="rss_language" type="text" id="rss_language" value="<?php form_option('rss_language'); ?>" size="20" class="code" /><br />
השפה העיקרית בפידים, בקודים בני שני תווים (למשל, he או en&rlm;) (<a href="http://www.w3.org/WAI/ER/IG/ert/iso639.htm">מקרא</a>)</td> 
</tr>
...
<?php /* WPH - Languge settings for RSS */ ?>
<input type="hidden" name="page_options" value="posts_per_page,what_to_show,posts_per_rss,rss_use_excerpt,blog_charset,rss_language,gzipcompression" /> 
