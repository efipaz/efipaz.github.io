...
<head profile="http://gmpg.org/xfn/11">
	...
	<title><?php bloginfo('name'); ?> <?php if ( is_single() ) { ?> &laquo; ארכיון <?php } ?> <?php wp_title(); ?></title>
...
<ul id="menu">
	<li><a href="<?php bloginfo('url'); ?>">ראשי</a></li>
	<li><a href="<?php bloginfo('url'); ?>/about">אודות</a></li>
	<li><a href="<?php bloginfo('url'); ?>/contact">קשר</a></li>
</ul>
