<?php
/*
Plugin Name: גיבוי בסיס הנתונים
Plugin URI: http://www.skippy.net/blog/plugins/
Description: גיבוי מלא של בסיס הנתונים של וורדרפס.
Author: סקוט מריל
Version: 1.7
...
class wpdbBackup {
	...
	function backup_menu() {
		...
		echo __('These core WordPress tables will always be backed up:') . '<br /><ul dir="ltr" style="padding-left:0;margin-left:0;">';
		// WPH - directionality
