...
<feed version="0.3"
  ...
  >
	...
	<entry>
		...
		<title type="text/html" mode="escaped"><![CDATA[<div dir="rtl"><?php the_title_rss() ?></div>]]></title>
		...
		<summary type="text/plain" mode="escaped"><![CDATA[<div dir="rtl"><?php the_excerpt_rss(); ?></div>]]></summary>
<?php if ( !get_settings('rss_use_excerpt') ) : ?>
		<content type="<?php bloginfo('html_type'); ?>" mode="escaped" xml:base="<?php permalink_single_rss() ?>"><![CDATA[<div dir="rtl"><?php the_content('', 0, '') ?></div>]]></content>
<?php endif; ?>
<?php rss_enclosure(); ?>
