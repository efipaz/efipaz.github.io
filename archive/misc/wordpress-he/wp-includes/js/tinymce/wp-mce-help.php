...
<div id="content3" class="hidden">
	...
	<table id="keys" width="100%" border="0">
		<tr class="top"><th class="key center">מקש</th><th class="center"><?php _e('Action') ?></th><th class="key center">מקש</th><th class="center"><?php _e('Action') ?></th></tr>
		<?php /* WPH - Localization clash */ ?> 
