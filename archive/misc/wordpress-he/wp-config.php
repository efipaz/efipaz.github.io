<?php
// ** MySQL settings ** //
define('DB_NAME', 'tarot_wordpress_efi');	// שם בסיס הנתונים (Name of the database)
define('DB_USER', 'tarot_efiadmin');		// שם משתמש עם הרשאות מלאות בבסיס הנתונים (Username on database)
define('DB_PASSWORD', 'Ef1Adm1n');		// ...והסיסמה שלו (Username's password)
define('DB_HOST', 'mysql.secured.co.il');	// ברוב המקרים לא צריך לשנות את זה (Database host - usualy you don't need to change this)
